        ...
        <div class="row wrapper">
            <div id="book-appointment" class="col-12 col-lg-10 col-xl-8">
                ...
                <div id="booking-frame-2" class="booking-frame" style="display:none;">
                    ...
                    <div class="command-buttons">
                        <button type="button" id="button-back-2" class="btn button-back btn-previous-light"
                            data-step_index="2">
                ...
                <div id="booking-frame-3" class="booking-frame" style="display:none;">
                    ...
                    <div class="command-buttons">
                        <button type="button" id="button-back-3" class="btn button-back btn-previous-light"
                            data-step_index="3">
                            <i class="fas fa-chevron-left mr-2"></i>
                            Vissza
                        </button>
                ...
                <div id="booking-frame-4" class="booking-frame" style="display:none;">
                    ...
                    <div class="command-buttons">
                        <button type="button" id="button-back-4" class="btn button-back btn-previous-light"
                            data-step_index="4">
                            <i class="fas fa-chevron-left mr-2"></i>
                            Vissza
                        </button>
